...
describe('GET /api/session/user Test Suite', () => {
  ...
  beforeAll(async () => {
    ...
    GET_USER = await utils.createUserWithJWT(app, 'picklerick@c137.com', 'vindicators');
  });
...
describe('POST /api/session Test Suite', () => {
  ...
  beforeAll(async () => {
    ...
    POST_SESSION_USER = await utils.createUser('picklerick@c137.com', 'vindicators');
  });
...
describe('DELETE /api/session Test Suite', () => {
  ...
  beforeAll(async () => {
    ...
    DELETE_SESSION_USER = await utils.createUserWithJWT(app, 'darthvader@starwars.com', 'order66');
  });
...
describe('Protected Endpoints Test Suite', () => {
  ...
  test('request with blacklisted JWT should be rejected by protected endpoint', async () => {
    ...
    USER = await utils.createUserWithJWT(app, 'chickennoodle@soup.com', 'welldonesteak');
