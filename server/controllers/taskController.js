...
exports.createTask = [
  ...
  body("due")
    ...
    .not()
    .isEmpty()
    .withMessage("Task due timestamp is required")
    .bail()
    .isInt({ min: 0, allow_leading_zeros: false })
    .withMessage(
      "Task due timestamp needs to be in Unix time and greater than 0"
    )
    .bail()
    .custom((value) => value > Math.floor(Date.now() / 1000))
    .withMessage("Task due timestamp cannot be in the past")
    .bail()
    .escape(),
